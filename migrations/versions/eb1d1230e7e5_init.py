...
Revision ID: eb1d1230e7e5
Revises: 
Create Date: 2023-10-09 11:27:43.380587
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('result_user_id', sa.Integer(), nullable=False),
    sa.Column('result_company_id', sa.Integer(), nullable=False),
    ...
    sa.Column('question_correct_answer', sa.String(), nullable=False),
