...
class CompanyMembersService:
    ...
    async def add_admin(self,
        ...
        await self.validate_access_for_admins(current_user, company.owner_id, company.id, user_id)
    ...
    async def validate_access_for_admins(self, current_user: int, company_owner: int, company_id: int, user_id: int):
