...
class ResultsService:
    ...
    async def add_results(self, quiz_id: int, current_user: int, correct_count: int, total_count: int):
        await self.results_repo.add_one({
            "result_user_id": current_user,
            "result_company_id": current_user,
    ...
    async def get_company_average_rating(self,
        ...
        user_results = await self.results_repo.find_by_filter(
            {
